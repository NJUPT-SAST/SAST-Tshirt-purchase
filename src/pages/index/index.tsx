...
const Index = () => {
  ...
  return (
    <View className="wrapper">
      <Image className="logo" src="https://guangzhou-store.mxte.cc/sast-t-shirt/welcome.png" />
